...
Pamiętaj też o dobrych praktykach podczas pisania testów, opisałem je w artykule poświęconym tematyce [testów jednostkowych](http://www.samouczekprogramisty.pl/testy-jednostkowe-z-junit/). Przy TDD praktyki te jak najbardziej obowiązują.
...
Bez najmniejszego wahania mogę polecić książkę autorstwa Kent’a Beck’a, [Test Driven Development by Example](http://www.samouczekprogramisty.pl/ksiazka-beck-tdd). W książce tej autor na podstawie problemu do rozwiązania pokazuje krok po kroku jak wygląda technika TDD. Chociaż książka nie jest zbyt obszerna, zawiera także sporo informacji związanych z tematyką testów jednostkowych.
