...
Jeśli Twoim zdaniem ta konwencja jest bez sensu porozmawiaj o tym z innymi członkami zespołu. Każdy przypadek powinien być rozpatrywany indywidualnie, dodatkowo konsensus może usprawiedliwić zmianę istniejącej konwencji.
...
Zwróć szczególną uwagę na zmianę sygnatury metody. Tego typu zmiany mogą prowadzić do „dziwnych zachowań”. Mam tu na myśli sytuację, w której metoda nadpisywała inną w klasie bazowej.
{:.notice--warning}

#### Niepotrzebne atrybuty

#### Martwy, nadmiarowy kod

Osobną klasą „błędów” może być niepotrzebnie skomplikowana logika, albo martwe gałęzie kodu.
